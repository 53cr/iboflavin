class CoreScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.dependency 'core_model', [name] + @args, :collision => :skip
    end
  end
  ...
  protected
  def banner
    "Usage: #{$0} core_scaffold ModelName [field:type, field:type]"
  end
