  ...
  DATA = {
    ...
    :male => {
      ...
      (19...30) => Nutrition::Requirements.new({
        :vit_a=>900, :vit_c=>90, :vit_d=>5, :vit_e=>15, :vit_k=>120,
         ...
         :choline=>550,
         :calcium=>1_000, :chromium=>35, :copper=>0.900, :fluoride=>4000,
      ...
      (51...70) => Nutrition::Requirements.new({
        :vit_a=>900, :vit_c=>90, :vit_d=>10, :vit_e=>15, :vit_k=>120,
         ...
         :folate=>400, :vit_b12=>2.4, :pantothenic=>5, :biotin=>30,
         :choline=>550,
         :calcium=>1_200, :chromium=>30, :copper=>0.900, :fluoride=>4000,
         :iodine=>150, :iron=>8, :magnesium=>420, :manganese=>2.3,
         :molybdenum=>45, :phosphorus=>700, :selenium=>55, :zinc=>11,
         :potassium=>4700, :sodium=>1300, :chloride=>2.0
        }),
      (70...999) => Nutrition::Requirements.new({
        :vit_a=>900, :vit_c=>90, :vit_d=>15, :vit_e=>15, :vit_k=>120,
         ...
         :iodine=>150, :iron=>8, :magnesium=>420, :manganese=>2.3,
         :molybdenum=>45, :phosphorus=>700, :selenium=>55, :zinc=>11,
         :potassium=>4700, :sodium=>1200, :chloride=>1.8
        }),
    },
    :female => {
      (9...14) => Nutrition::Requirements.new({
        ...
        :folate=>300, :vit_b12=>1.8, :pantothenic=>4, :biotin=>20,
        :choline=>375,
        :calcium=>1_300, :chromium=>21, :copper=>0.700, :fluoride=>2000,
      ...
      (14...19) => Nutrition::Requirements.new({
        ...
        :folate=>400, :vit_b12=>2.4, :pantothenic=>5, :biotin=>25,
        :choline=>400,
        :calcium=>1_300, :chromium=>24, :copper=>0.890, :fluoride=>3000,
      ...
      (19...30) => Nutrition::Requirements.new({
        ...
        :folate=>400, :vit_b12=>2.4, :pantothenic=>5, :biotin=>30,
        :choline=>425,
        :calcium=>1_000, :chromium=>25, :copper=>0.900, :fluoride=>3000,
      ...
      (51...70) => Nutrition::Requirements.new({
        ...
        :folate=>400, :vit_b12=>2.4, :pantothenic=>5, :biotin=>30,
        :choline=>425,
        :calcium=>1_200, :chromium=>20, :copper=>0.900, :fluoride=>3000,
    ...
    :pregnant => {
      (14...19) => Nutrition::Requirements.new({
        ...
        :choline=>450,
        :calcium=>1_300, :chromium=>29, :copper=>1.000, :fluoride=>3000,
      ...
      (19...31) => Nutrition::Requirements.new({
        ...
        :folate=>600, :vit_b12=>2.6, :pantothenic=>6, :biotin=>30,
        :choline=>450,
        :calcium=>1_000, :chromium=>30, :copper=>1.000, :fluoride=>3000,
    ...
    :lactating => {
      ...
      (19...31) => Nutrition::Requirements.new({
        ...
        :folate=>500, :vit_b12=>2.8, :pantothenic=>7, :biotin=>35,
        :choline=>550,
        :calcium=>1_000, :chromium=>45, :copper=>1.300, :fluoride=>3000,
